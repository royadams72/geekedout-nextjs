...
export const comicsSlice = createAppSlice({
  ...
  reducers: (create) => ({
    loadComics: create.reducer((state, action: PayloadAction<ComicStore>) => {
  ...
  selectors: {
    selectComicsArray: (comics) => comics.comics.results,
    // selectStatus: (counter) => counter.status,
  },
});

// Action creators are generated for each case reducer function.
export const { loadComics } = comicsSlice.actions;
